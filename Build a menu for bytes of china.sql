...
--Task group 4
-- 10.
SELECT restaurant.name AS restaurant_name, address.street_number, address.street_name, restaurant.telephone
FROM restaurant, address
WHERE restaurant.id = address.restaurant_id;

--11.
SELECT restaurant.name AS restaurant_name, MAX(review.rating) AS best_rating
